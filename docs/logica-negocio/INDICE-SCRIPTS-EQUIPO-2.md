...
| **e2-69** | `cxp/sql/e2-69-factura-de-prueba-fuera-de-solicitud-de-pago.sql` | La factura de prueba `001-501-000000203` (CUSTODIA & MAXIMA SEGURIDAD, 12.295,80) se sigue ofreciendo en Solicitud de Pago. Los bloques 0-2 son **solo lectura**: la identifican, dicen cuánto saldo real le queda y si tiene un pago vivo. El BLOQUE 3 la marca como PAGADA (`FCTCEPAG = 3`) y va **comentado**. Documenta además la opción B (anular), que NO hace por SQL | 🔴 **PENDIENTE — 2026-09-22.** El BLOQUE 1 decide: con saldo 0 la opción A es exacta; con saldo > 0 deja ese saldo colgado en el estado de cuenta |
