-- =====================================================
-- MODULO: RHH - MAYO YA CERRADO: LA ULTIMA DEL MES
...
-- --34 de la apertura y 12 de los cuatro finiquitos, 3 cada uno--. 670.
-- Las 46 sin periodo NO se mueven este mes: mayo tampoco tiene salidas.
-- =====================================================
