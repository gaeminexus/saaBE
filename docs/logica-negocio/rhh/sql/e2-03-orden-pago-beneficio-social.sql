...
-- 0.4 Los codigos concretos deben estar libres. ESPERADO: 0 filas las tres.
--     OJO CON LA TERCERA: el codigo NO es lo mismo que el codigo alterno, y el
--     codigo es el que reserva el registro mientras que el ALTERNO es el que usa
--     el codigo para buscar el rubro (DetalleRubroDaoService.selectValorString-
--     ByRubAltDetAlt filtra por t.rubro.codigoAlterno). Hay que verificar los dos.
SELECT PRBRCDGO FROM SCP.PRBR WHERE PRBRCDGO = 310;
SELECT PDTRCDGO FROM SCP.PDTR WHERE PDTRCDGO BETWEEN 1500 AND 1503;
SELECT PRBRCDGO, PRBRDSCR FROM SCP.PRBR WHERE PRBRALTR = 310;
...
VALUES (310, 'RHH ESTADO DE ORDEN DE BENEFICIO SOCIAL', SYSDATE, 310, 1);

INSERT INTO SCP.PDTR (PDTRCDGO, PRBRCDGO, PDTRDSCR, PDTRALTR, PDTRESTD)
VALUES (1500, 310, 'GENERADA', 1, 1);
INSERT INTO SCP.PDTR (PDTRCDGO, PRBRCDGO, PDTRDSCR, PDTRALTR, PDTRESTD)
VALUES (1501, 310, 'ENVIADA A TESORERIA', 2, 1);
INSERT INTO SCP.PDTR (PDTRCDGO, PRBRCDGO, PDTRDSCR, PDTRALTR, PDTRESTD)
VALUES (1502, 310, 'PAGADA', 3, 1);
INSERT INTO SCP.PDTR (PDTRCDGO, PRBRCDGO, PDTRDSCR, PDTRALTR, PDTRESTD)
VALUES (1503, 310, 'ANULADA', 4, 1);
