...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhEstadoCargaMarcaciones (194)
 *         Estado de la carga de marcaciones (CRMRESTD)
 */
public interface RhhEstadoCargaMarcaciones {
	...
	public static final int CON_ERRORES = 3;
	public static final int CONSOLIDADO = 4;
