...
/**
 * @author GaemiSoft
 *         Interfaz del rubro PathFuentes (5)
 */
public interface PathFuentes {

	// Id del rubro padre
	public static final int ID = 5;
	public static final String NOMBRE = "PAHT DE FUENTES";
	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int FORMAS = 1;
	public static final int REPORTES = 2;
	public static final int ICONOS = 3;
