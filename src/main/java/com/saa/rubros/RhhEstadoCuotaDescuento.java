...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhEstadoCuotaDescuento (222)
 *         Estado de la cuota de un descuento recurrente (CTDSESTD)
 */
public interface RhhEstadoCuotaDescuento {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int PENDIENTE = 1;
	public static final int DESCONTADA = 2;
