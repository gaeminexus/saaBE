...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhModalidadFondosReserva (190)
 *         Modalidad de pago de los fondos de reserva (CNTEFRMD)
 */
public interface RhhModalidadFondosReserva {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int MENSUALIZADO = 1;
	public static final int ACUMULADO_EN_EL_IESS = 2;
