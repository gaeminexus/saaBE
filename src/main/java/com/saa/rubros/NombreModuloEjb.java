...
/**
 * @author GaemiSoft
 *         Interfaz del rubro NombreModuloEjb (46)
 */
public interface NombreModuloEjb {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int CONTABILIDAD = 1;
	public static final int TESORERIA = 2;
	public static final int EAR_FILE = 3;
	public static final String VALOR_CONTABILIDAD = "Contabilidad/";
	public static final String VALOR_TESORERIA = "Tesoreria/";
	public static final String VALOR_EAR_FILE = "AotEAR/";
