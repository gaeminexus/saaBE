...
/**
 * @author GaemiSoft
 *         Interfaz del rubro ReporteTipoDistribucion (60)
 */
public interface ReporteTipoDistribucion {

	// Ids de los elementos hijos
	public static final int SIN_CENTRO_COSTO = 0;
	public static final int CENTRO_COSTO_POR_CUENTA_CONTABLE = 1;
	public static final int CUENTA_CONTABLE_POR_CENTRO_COSTO = 2;
