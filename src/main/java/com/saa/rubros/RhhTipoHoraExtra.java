...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhTipoHoraExtra (191)
 *         Tipo de hora extra (HREXTPHR). El PDTRVLRN lleva el porcentaje de recargo
 */
public interface RhhTipoHoraExtra {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int SUPLEMENTARIA_50 = 1;
	public static final int EXTRAORDINARIA_100 = 2;
	public static final int RECARGO_NOCTURNO_25 = 3;
