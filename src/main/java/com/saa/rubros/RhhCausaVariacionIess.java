...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhCausaVariacionIess (229)
 *         Causa de la variacion de sueldo por extras, un digito, campo "causa" del
 *         registro INS del archivo batch. El codigo esta en PDTRVLRV.
 */
public interface RhhCausaVariacionIess {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int HORAS_EXTRAS_Y_SUPLEMENTARIAS = 1;
	public static final int SUBROGACION = 2;
	public static final int ENCARGO = 3;
	public static final int OTROS_INGRESOS_IMPONIBLES_NO_PERMANENTES = 4;
