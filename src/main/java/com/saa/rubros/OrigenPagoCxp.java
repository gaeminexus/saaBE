 ...
 *         (PGS.PGTR): factura de compra, liquidación de compra, egreso de tesorería
 *         o anticipo a proveedor.
 *
 ...
 *         {@code GET /pgtr/porAprobar}: un pago de CXP siempre cae en una de estas cuatro, o en
 *         una de {@link OrigenPagoExterno} si {@code PGTRORGN} no es nulo.
 *
 *         A diferencia de {@link OrigenPagoExterno}, estas cuatro SÍ se resuelven en CXP: cada
 *         una corresponde exactamente a que {@code facturaCompra}/{@code liquidacionCompra}/
 *         {@code egreso}/{@code anticipo} de {@code PagoProgramado} sea el que está no-nulo.
 */
public interface OrigenPagoCxp {
	...
	/** El pago paga una liquidación de compra (PGS.LQCC). */
	String LIQUIDACION_COMPRA = "LIQUIDACION_COMPRA";
