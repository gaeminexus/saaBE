...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhTipoMarcacion (192)
 *         Tipo de marcacion (MRCCTPOO)
 */
public interface RhhTipoMarcacion {
	...
	public static final int SALIDA_ALMUERZO = 3;
	public static final int RETORNO_ALMUERZO = 4;
	public static final int SALIDA_PERMISO = 5;
	public static final int RETORNO_PERMISO = 6;
