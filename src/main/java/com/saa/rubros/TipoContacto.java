...
/**
 * @author GaemiSoft
 *         Interfaz del rubro TipoCliente (106)
 */
public interface TipoContacto {

	// Ids de los elementos hijos
	public static final int CONVENCIONAL = 1;
	public static final int MOVIL = 2;
	public static final int EMAIL = 3;
	public static final int MOVI = 4;
	public static final int CLARO = 5;
