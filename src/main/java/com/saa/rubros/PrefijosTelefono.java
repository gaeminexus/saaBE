...
/**
 * @author GaemiSoft
 *         Interfaz del rubro PrefijosTelefono (39)
 */
public interface PrefijosTelefono {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int PREFIJO_02 = 1;
	public static final int PREFIJO_03 = 2;
	public static final int PREFIJO_04 = 3;
	public static final int PREFIJO_05 = 4;
	public static final int PREFIJO_06 = 5;
	public static final int PREFIJO_07 = 6;
