...
/**
 * @author GaemiSoft
 *         Interfaz del rubro ErroresSistema (4)
 */
public interface ErroresSistema {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int NUMERO_INCORRECTO_RUC = 1;
	public static final int VALOR_INCORRECTO_RUC = 2;
	public static final int INGRESAR_NUMERO = 3;
