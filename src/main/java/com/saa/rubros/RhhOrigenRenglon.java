...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhOrigenRenglon (213)
 *         Origen del renglon de nomina (RNGLORGN)
 */
public interface RhhOrigenRenglon {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int CALCULO_AUTOMATICO = 1;
	public static final int NOVEDAD_DEL_PERIODO = 2;
	public static final int DESCUENTO_RECURRENTE = 3;
	public static final int HORA_EXTRA = 4;
	public static final int CONCEPTO_FIJO_DEL_EMPLEADO = 5;
	public static final int INGRESO_MANUAL = 6;
