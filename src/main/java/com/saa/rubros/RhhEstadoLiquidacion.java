...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhEstadoLiquidacion (196)
 *         Estado de la liquidacion de haberes (LQDCESTD)
 */
public interface RhhEstadoLiquidacion {
	...
	public static final int REGISTRADA_EN_SUT = 4;
	public static final int PAGADA = 5;
