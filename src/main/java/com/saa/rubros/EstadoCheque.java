...
/**
 * @author GaemiSoft
 *         Interfaz del rubro EstadoCheque (26)
 */
public interface EstadoCheque {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int ACTIVO = 1;
	public static final int ANULADO = 2;
	public static final int GENERADO = 3;
	public static final int IMPRESO = 4;
	public static final int DANIADO = 5;
