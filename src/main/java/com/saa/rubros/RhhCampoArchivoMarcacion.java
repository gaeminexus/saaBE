...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhCampoArchivoMarcacion (215)
 *         Campo logico del archivo de marcaciones (DFMRCMPO)
 */
public interface RhhCampoArchivoMarcacion {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int ID_EMPLEADO = 1;
	public static final int FECHA = 2;
	public static final int HORA = 3;
	public static final int FECHA_Y_HORA = 4;
	public static final int TIPO_MARCACION = 5;
	public static final int ID_DISPOSITIVO = 6;
	public static final int IDENTIFICACION = 7;
