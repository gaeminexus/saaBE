...
/**
 * @author GaemiSoft
 *         Interfaz del rubro PlantillasSistema (53)
 */
public interface PlantillasSistema {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int CUENTA_CIERRE = 1;
	public static final int RETENCIONES = 2;
	public static final int TARJETA_CREDITO = 3;
	public static final int MOTIVO_DEBITO_BANCARIO = 4;
	public static final int MOTIVO_CREDITO_BANCARIO = 5;
	public static final int MOTIVOS_PAGO = 6;
	public static final int MOTIVOS_COBRO = 7;
