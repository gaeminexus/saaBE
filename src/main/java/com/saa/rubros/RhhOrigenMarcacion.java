...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhOrigenMarcacion (193)
 *         Origen de la marcacion (MRCCORGN)
 */
public interface RhhOrigenMarcacion {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int BIOMETRICO = 1;
	public static final int MANUAL = 2;
	public static final int IMPORTACION_ARCHIVO = 3;
	public static final int APLICACION_MOVIL = 4;
	public static final int CORRECCION_APROBADA = 5;
