...
/**
 * @author GaemiSoft
 *         Interfaz del rubro ReportesBasicos (27)
 */
public interface ReportesBasicos {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int BALANCE_GENERAL = 1;
	public static final int ESTADO_DE_PYG = 2;
	public static final int ESTADO_DE_COMPROBACION = 3;
