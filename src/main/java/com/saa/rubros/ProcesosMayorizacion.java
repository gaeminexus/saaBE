...
/**
 * @author GaemiSoft
 *         Interfaz del rubro ProcesosMayorizacion (49)
 */
public interface ProcesosMayorizacion {

	// Ids de los elementos
	public static final int RAIZ = 0;
	public static final int MAYORIZACION = 1;
	public static final int MAYORIZACION_CIERRE = 2;
	public static final int DESMAYORIZACION = 3;
	public static final int DESMAYORIZACION_CIERRE = 4;
