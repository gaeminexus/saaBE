...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhTipoPeriodoNomina (212)
 *         Tipo de periodo de nomina (PRDNTPPR)
 */
public interface RhhTipoPeriodoNomina {
	...
	public static final int DECIMO_TERCERO = 3;
	public static final int DECIMO_CUARTO = 4;
	public static final int UTILIDADES = 5;
	public static final int LIQUIDACION = 6;
	public static final int BONO_EXTRAORDINARIO = 7;
