...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhParentescoCarga (200)
 *         Parentesco de la carga familiar (CRGFPRNT)
 */
public interface RhhParentescoCarga {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int CONYUGE = 1;
	public static final int CONVIVIENTE = 2;
	public static final int HIJO = 3;
	public static final int PADRE = 4;
	public static final int MADRE = 5;
	public static final int HERMANO = 6;
