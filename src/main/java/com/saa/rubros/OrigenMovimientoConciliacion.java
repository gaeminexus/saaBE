...
/**
 * @author GaemiSoft
 *         Interfaz del rubro OrigenMovimientoConciliacion (41)
 */
public interface OrigenMovimientoConciliacion {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int COBROS = 1;
	public static final int PAGOS = 2;
	public static final int CREDITO_BANCARIO = 3;
	public static final int DEBITO_BANCARIO = 4;
	public static final int TRANSFERENCIA_CREDITO = 5;
	public static final int TRANSFERENCIA_DEBITO = 6;
