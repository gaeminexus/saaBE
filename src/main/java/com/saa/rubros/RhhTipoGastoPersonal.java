...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhTipoGastoPersonal (201)
 *         Tipo de gasto personal proyectado (GSPRTPGS)
 */
public interface RhhTipoGastoPersonal {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int VIVIENDA = 1;
	public static final int EDUCACION_ARTE_Y_CULTURA = 2;
	public static final int ALIMENTACION = 3;
	public static final int VESTIMENTA = 4;
	public static final int SALUD = 5;
	public static final int TURISMO = 6;
