...
/**
 * @author GaemiSoft
 *         Interfaz del rubro EstadoChequera (25)
 */
public interface EstadoChequera {
	...
	public static final int SOLICITADA = 3;
	public static final int TERMINADA = 4;
	public static final int PERDIDA = 5;
