...
/**
 * @author GaemiSoft
 *         Interfaz del rubro GrupoCuentasBasicas (20)
 */
public interface GrupoCuentasBasicas {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int ACTIVOS = 1;
	public static final int PASIVOS = 2;
	public static final int PATRIMONIO = 3;
	public static final int INGRESOS = 4;
