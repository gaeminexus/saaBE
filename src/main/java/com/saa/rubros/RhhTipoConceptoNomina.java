...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhTipoConceptoNomina (179)
 *         Tipo de concepto de nomina (CPNMTPCN)
 */
public interface RhhTipoConceptoNomina {
	...
	public static final int APORTE_PATRONAL = 3;
	public static final int PROVISION = 4;
	public static final int INFORMATIVO = 5;
