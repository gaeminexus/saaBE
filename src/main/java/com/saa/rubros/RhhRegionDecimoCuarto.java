...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhRegionDecimoCuarto (187)
 *         Region que define el periodo del decimo cuarto (MPLDRGNN)
 */
public interface RhhRegionDecimoCuarto {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int SIERRA_Y_AMAZONIA = 1;
	public static final int COSTA_E_INSULAR = 2;
