...
/**
 * @author GaemiSoft
 *         Interfaz del rubro CambioCuponesGanados (103)
 */
public interface CambioCuponesGanados {

	// Ids de los elementos hijos
	public static final int RANGO_CLIENTE = 1;
	public static final int TIPO_FORMA_PAGO = 2;
	public static final int LOCALES = 3;
	public static final int VALOR = 4;
	public static final int MES_NACIMIENTO = 5;
