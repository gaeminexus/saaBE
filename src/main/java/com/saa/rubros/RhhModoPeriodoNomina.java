...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhModoPeriodoNomina (184)
 *         Modo del periodo de nomina (PRDNMODO). Interruptor de contabilizacion
 */
public interface RhhModoPeriodoNomina {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int HISTORICO_SIN_CONTABILIZAR = 1;
	public static final int PRODUCTIVO_CONTABILIZA = 2;
