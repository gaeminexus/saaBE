...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhEstadoOrdenBeneficio (310)
 *         Estado de la orden de pago de beneficio social (RHH.ODBS.ODBSESTD)
 */
public interface RhhEstadoOrdenBeneficio {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int GENERADA = 1;
	public static final int ENVIADA_A_TESORERIA = 2;
