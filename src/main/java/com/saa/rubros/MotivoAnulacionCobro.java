...
/**
 * @author GaemiSoft
 *         Interfaz del rubro MotivoAnulacionCobro (29)
 */
public interface MotivoAnulacionCobro {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int CAMBIO_DE_NOMBRE = 1;
	public static final int CAMBIO_DE_VALORES = 2;
