...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhNivelInstruccion (220)
 *         Nivel de instruccion del empleado (MPLDNVIN)
 */
public interface RhhNivelInstruccion {
	...
	public static final int TERCER_NIVEL = 4;
	public static final int CUARTO_NIVEL = 5;
	public static final int NINGUNA = 6;
