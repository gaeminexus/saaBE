...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhOrigenPagoIess (227)
 *         Codigo de origen de pago del IESS, un digito, campo "Origen de pago" del
 *         aviso de entrada. El codigo esta en PDTRVLRV.
 */
public interface RhhOrigenPagoIess {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int FONDOS_PRIVADOS = 1;
	public static final int FONDOS_PUBLICOS = 2;
