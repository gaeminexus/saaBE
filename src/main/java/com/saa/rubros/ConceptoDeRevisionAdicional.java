...
/**
 * @author GaemiSoft
 *         Interfaz del rubro Alertas (135)
 */
public interface ConceptoDeRevisionAdicional {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int NUMERO_PERSONAS = 1;
	public static final int ACTIVIDAD = 2;
