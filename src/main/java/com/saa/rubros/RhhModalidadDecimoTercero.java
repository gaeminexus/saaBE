...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhModalidadDecimoTercero (188)
 *         Modalidad de pago del decimo tercero (CNTEDCTM)
 */
public interface RhhModalidadDecimoTercero {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int MENSUALIZADO = 1;
	public static final int ACUMULADO = 2;
