...
/**
 * @author GaemiSoft
 *         Interfaz del rubro FormatoNumero (67)
 */
public interface FormatoNumero {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int NORMAL_SIN_DECIMALES = 1;
	public static final int NORMAL_CON_DECIMALES = 2;
	public static final int MILLAR_SIN_DECIMALES = 3;
	public static final int MILLAR_CON_DECIMALES = 4;
	public static final int MONEDA_CON_MILLAR = 5;
	public static final int MONEDA_SIN_MILLAR = 6;
