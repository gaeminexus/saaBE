...
/**
 * @author GaemiSoft
 *         Interfaz del rubro MotivoAnulacionPago (34)
 */
public interface MotivoAnulacionPago {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int CAMBIO_DE_PROVEEDOR = 1;
	public static final int ERROR_EN_DATOS = 2;
