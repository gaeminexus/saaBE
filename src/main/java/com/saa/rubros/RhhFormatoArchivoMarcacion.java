...
/**
 * @author GaemiSoft
 *         Interfaz del rubro RhhFormatoArchivoMarcacion (209)
 *         Tipo de formato del archivo de marcaciones (FMRCTPFR)
 */
public interface RhhFormatoArchivoMarcacion {

	// Codigos alternos de los detalles del rubro (SCP.PDTR.PDTRALTR)
	public static final int ANCHO_FIJO = 1;
	public static final int DELIMITADO = 2;
