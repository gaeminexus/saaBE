...
/**
 * @author GaemiSoft
 *         Interfaz del rubro MovimientoCuentaPlantilla (17)
 */
public interface MovimientoCuentaPlantilla {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int DEBE = 1;
	public static final int HABER = 2;
