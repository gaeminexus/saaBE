...
/**
 * @author GaemiSoft
 *         Interfaz del rubro TipoParametrosFunciones (3)
 */
public interface TipoParametrosFunciones {

	// Ids de los elementos hijos
	public static final int RAIZ = 0;
	public static final int MISMO_VALOR = 1;
	public static final int CONSTANTE = 2;
	public static final int OTRA_CARACTERISTICA = 3;
