...
/**
 * @author GaemiSoft.
 *         Interface DAO para la entidad Saldos.
 */
@Local
public interface SaldosDaoService extends EntityDao<Saldos> {
	 ...
	 */	
	List<Long> selectAniosSaldos(Long empresa) throws Throwable;
	...
	*/
	 ...
	 * @throws Throwable: Excepcion
	 */
	List<Saldos> selectSaldosReverso(Long empresa) throws Throwable;
	 ...
	 * @throws Throwable: Excepcion
	 */
	List<Saldos> selectByMesAnio(Long mes, Long anio, Long empresa) throws Throwable;
	 ...
	 * @throws Throwable: Excepcion
	 */
	List<Saldos> selectMaxNumero(Long tipo, Long empresa) throws Throwable;
	 ...
	 * @throws Throwable: Excepcion
	 */
	Saldos selectSaldosCierre(Long mes, Long anio, Long tipo, Long empresa) throws Throwable;
	 ...
	 * @param empresa	: Id de la empresa
	 * @param tipo		: Id de tipo de asiento
	 * @return			: Saldos recuperado
	 * @throws Throwable: Excepcion
	 */
	Saldos selectByNumeroEmpresaTipo(Long numero, Long empresa, Long tipo) throws Throwable;
	 ...
	 * @throws Throwable		: Excepcion
	 */
	List<Saldos> selectByMayorizacion(Long idMayorizacion) throws Throwable;
	
	/**
	 * Recupera Datos de Consulta de Saldoss
	 * @param idEmpresa				: Id de laEmpresa
	 * @param tipoSaldos			: Tipo de Saldos
	 * @param numero				: Numero
	 * @param estado				: Estado
	 ...
	 * @param fechaSaldosDesde  	: Fecha Saldos Desde
	 * @param fechaSaldosHasta		: Fecha Saldos Hasta
	 * @return						: Datos de Consulta
	 * @throws Throwable			: Excepcions 
	 */
	
	List<Saldos> selectByConsultaCamposSaldos (Long idEmpresa, Long tipoSaldos, Long numero,
												 ...
												 Date fechaIngresoHasta, Date fechaSaldosDesde, Date fechaSaldosHasta
												 )throws Throwable;
	 ...
	 * @throws Throwable	: Excepcion
	 */
	List<Saldos> selectByIdPeriodo(Long idPeriodo) throws Throwable;
