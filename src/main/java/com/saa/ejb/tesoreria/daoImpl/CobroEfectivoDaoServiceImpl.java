 ...
 * @author GaemiSoft
 *
 * Implementacion CobroEfectivoDaoService.
 */
@Stateless
public class CobroEfectivoDaoServiceImpl extends EntityDaoImpl<CobroEfectivo> implements CobroEfectivoDaoService {
	...
	/* (non-Javadoc)
	 * @see com.compuseg.income.tesoreria.ejb.dao.CobroEfectivoDaoService#selectSumaByCobro(java.lang.Long)
	 */
	...
	@Override
	public List<CobroEfectivo> selectByIdCobro(Long idCobro) throws Throwable {
		System.out.println("CobroEfectivo - selectByIdCobro con id cobro: "+idCobro);
		Query query = em.createQuery(" SELECT   b " +
									 " FROM     CobroEfectivo b " +
