...
@Local
public interface DetalleEjecucionReporteDaoService extends EntityDao<DetalleEjecucionReporte> {
     ...
     * Se usan para saber qué Gs hay que re-ejecutar.
     * @param idEjecucion : Id de la cabecera de ejecución
     * @return            : Listado de detalles pendientes o con novedades
     * @throws Throwable  : Excepcion
     */
