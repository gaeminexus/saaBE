...
public interface ProductoCobroService extends EntityService<ProductoCobro> {
	 ...
	 */
	  ...
	  * @param idGrupo		: Id del grupo de producto de cobro
	 ...
	 * @throws Throwable	: Excepcion
	 */
	 List<ProductoCobro> recuperaProductosHijo(Long id) throws Throwable;
	 ...
	 * @throws Throwable	: Excepcion
	 */
	 ProductoCobro buscaMayorNumeroProducto(List<ProductoCobro> listadoProducto) throws Throwable;
