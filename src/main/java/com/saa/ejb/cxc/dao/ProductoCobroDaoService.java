...
public interface ProductoCobroDaoService  extends EntityDao<ProductoCobro>  {
	...
	/**
	 * Recupera los productos de cobro de una empresa
	 * @param idGrupo		: Id del grupo de producto de cobro del que se recupera los productos
	 * @return				: Lista de productos que contiene el grupo
	 * @throws Throwable	: Excepcion
	 */
	List<ProductoCobro> selectByGrupo(Long idGrupo) throws Throwable;
	 ...
	 * @throws Throwable: Excepcion
	 */
	ProductoCobro selectRaizByGrupo(Long idGrupo) throws Throwable;
	 ...
	 * @throws Throwable: Excepcion
	 */
	ProductoCobro selectByNumeroGrupo(String numero, Long idGrupo) throws Throwable;
	 ...
	 * @throws Throwable	: Excepcion
	 */
	List<ProductoCobro> selectHijosByNumeroProducto(String numeroProducto, Long idGrupo) throws Throwable;
	 ...
	 * @throws Throwable	: Excepcion
	 */
	List<ProductoCobro> selectByIdPadre(Long idPadre) throws Throwable;
