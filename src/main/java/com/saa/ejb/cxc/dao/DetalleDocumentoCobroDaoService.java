...
/**
 * @author GaemiSoft.
 * DaoService DetalleDocumentoCobro. 
 */
@Remote
public interface DetalleDocumentoCobroDaoService  extends EntityDao<DetalleDocumentoCobro>  {
	 ...
	 */
	DetalleDocumentoCobro recuperaConHijos(Long id) throws Throwable;
