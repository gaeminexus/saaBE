...
/**
 * @author GaemiSoft.
 * DaoService FinanciacionXDocumentoCobro. 
 */
@Remote
public interface FinanciacionXDocumentoCobroDaoService  extends EntityDao<FinanciacionXDocumentoCobro>  {
	 ...
	 */
	FinanciacionXDocumentoCobro recuperaConHijos(Long id) throws Throwable;
