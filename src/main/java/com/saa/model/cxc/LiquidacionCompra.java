...
/**
 * Entity LiquidacionCompra.
 * Almacena los datos de liquidación de compras y servicios.
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LQCS", schema = "CBR")
@NamedQueries({
	@NamedQuery(name = "LiquidacionCompraAll", query = "select e from LiquidacionCompra e"),
	@NamedQuery(name = "LiquidacionCompraId", query = "select e from LiquidacionCompra e where e.id = :id")
})
