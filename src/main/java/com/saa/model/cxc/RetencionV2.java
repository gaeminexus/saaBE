...
/**
 * Entity RetencionV2.
 * Almacena los datos de retenciones versión 2.
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "RTV2", schema = "CBR")
@NamedQueries({
	@NamedQuery(name = "RetencionV2All", query = "select e from RetencionV2 e"),
	@NamedQuery(name = "RetencionV2Id", query = "select e from RetencionV2 e where e.id = :id")
})
public class RetencionV2 implements Serializable {
