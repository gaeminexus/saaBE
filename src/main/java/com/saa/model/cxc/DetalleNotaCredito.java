...
/**
 * Entity DetalleNotaCredito.
 * Almacena el detalle de items de la nota de crédito.
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "DTNC", schema = "CBR")
@NamedQueries({
	@NamedQuery(name = "DetalleNotaCreditoAll", query = "select e from DetalleNotaCredito e"),
	@NamedQuery(name = "DetalleNotaCreditoId", query = "select e from DetalleNotaCredito e where e.id = :id")
})
