...
/**
 * Entity NotaDebito.
 * Almacena los datos de notas de débito.
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "NTDB", schema = "CBR")
@NamedQueries({
	@NamedQuery(name = "NotaDebitoAll", query = "select e from NotaDebito e"),
	@NamedQuery(name = "NotaDebitoId", query = "select e from NotaDebito e where e.id = :id")
})
public class NotaDebito implements Serializable {
	...
	@Basic
	@Column(name = "TIPODOCMODIFICADO", length = 45)
	private String tipoDocModificado;
	
	@Basic
	@Column(name = "NUMDOCMODIFICADO", length = 500)
	private String numDocModificado;
	
	@Basic
	@Column(name = "FECHAEMISIONDM")
	...
	/**
	 * Factura de CXC a la que está relacionada esta nota de débito.
	 * Toda nota de débito debe estar vinculada a una factura del mismo cliente.
	 */
	@ManyToOne
	...
	public String getTipoDocModificado() {
		return tipoDocModificado;
	}

	public void setTipoDocModificado(String tipoDocModificado) {
		this.tipoDocModificado = tipoDocModificado;
	}
	...
	public LocalDateTime getFechaEmisionDM() {
		return fechaEmisionDM;
	}

	public void setFechaEmisionDM(LocalDateTime fechaEmisionDM) {
		this.fechaEmisionDM = fechaEmisionDM;
	}
