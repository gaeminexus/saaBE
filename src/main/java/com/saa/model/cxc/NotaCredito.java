...
/**
 * Entity NotaCredito.
 * Almacena los datos de notas de crédito.
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "NTCR", schema = "CBR")
@NamedQueries({
	@NamedQuery(name = "NotaCreditoAll", query = "select e from NotaCredito e"),
	@NamedQuery(name = "NotaCreditoId", query = "select e from NotaCredito e where e.id = :id")
})
