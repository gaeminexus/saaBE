...
/**
 *  @author GaemiSoft
 * <p>Pojo mapeo de tabla TSR.TPGS.
 *  Entity Temporal de pago.
 *  Almacena el pago de manera temporal durante el ingreso del pago.
 *  Luego pasara a la tabla TSR.PGSS.</p>
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "TPGS", schema = "TSR")
@SequenceGenerator(name = "SQ_TPGSCDGO", sequenceName = "TSR.SQ_TPGSCDGO", allocationSize = 1)
@NamedQueries({
	@NamedQuery(name = "TempPagoAll", query = "select e from TempPago e"),
	@NamedQuery(name = "TempPagoId", query = "select e from TempPago e where e.codigo = :id")
})
public class TempPago implements Serializable {
	...
	@Basic
	@Id
	@Column(name = "TPGSCDGO", precision = 0)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_TPGSCDGO")
	private Long codigo;
	 ...
	 */
	@Basic
	@Column(name = "TPGSIDNT", length = 20)
	 ...
	 */
	@Basic
	@Column(name = "TPGSPRVD", length = 200)
	 ...
	 */
	@Basic
	@Column(name = "TGSSDSCR", length = 300)
	 ...
	 */
	@Basic
	@Column(name = "TPGSUSRO", length = 50)
