...
public class DetalleAsiento implements Serializable {
	...
	/**
	 * NO persistido. Lo pone GrupoConciliacionAsientoDaoServiceImpl.selectPendientes cuando esta
	 * fila se trajo por el arrastre de una partida en tránsito de un período anterior (ver
	 * docs/logica-negocio/tsr/DISENO-CONCILIACION-PARTIDAS-EN-TRANSITO.md §7), no porque su
	 * fecha caiga dentro del período consultado. La fecha "original" ya está en
	 * {@code getAsiento().getFechaAsiento()} - no hace falta un campo aparte para eso.
	 */
