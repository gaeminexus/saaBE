...
/**
 * Entity DetalleNotaCreditoCompra.
 * Almacena el detalle de la nota de crédito de compra (tabla pgs.dtcc).
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "DTCC", schema = "PGS")
@NamedQueries({
	@NamedQuery(name = "DetalleNotaCreditoCompraAll", query = "select e from DetalleNotaCreditoCompra e"),
	@NamedQuery(name = "DetalleNotaCreditoCompraId", query = "select e from DetalleNotaCreditoCompra e where e.id = :id")
})
public class DetalleNotaCreditoCompra implements Serializable {
