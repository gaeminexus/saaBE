...
/**
 * Entity NotaCreditoCompra.
 * Almacena los datos de nota de crédito de compra (tabla pgs.ntcc).
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "NTCC", schema = "PGS")
@NamedQueries({
	@NamedQuery(name = "NotaCreditoCompraAll", query = "select e from NotaCreditoCompra e"),
	@NamedQuery(name = "NotaCreditoCompraId", query = "select e from NotaCreditoCompra e where e.id = :id")
})
public class NotaCreditoCompra implements Serializable {
	...
	private Long estado;
        ...
        /**
         * Asiento contable generado al contabilizar la nota de crédito de compra.
         */
        @ManyToOne
        ...
        /**
         * Sustento tributario SRI (Tabla 5 del ATS) de esta nota de crédito de compra (NTCCCSUS).
         ...
         */
        @Basic @Column(name = "NTCCCSUS", length = 2)
         ...
         */
        @Basic @Column(name = "NTCCMTAN", length = 1000)
        private String motivoAnulacion;

        @Basic @Column(name = "NTCCFCAN")
