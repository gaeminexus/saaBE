...
public class NotaDebitoCompra implements Serializable {
	...
	/**
	 * Sustento tributario SRI (Tabla 5 del ATS) de esta nota de débito de compra (NTDCCSUS).
	 ...
	 */
	@Basic @Column(name = "NTDCCSUS", length = 2)
	 ...
	 */
	@Basic @Column(name = "NTDCMTAN", length = 1000)
	private String motivoAnulacion;

	@Basic @Column(name = "NTDCFCAN")
