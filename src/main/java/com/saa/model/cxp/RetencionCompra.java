...
/**
 * Entity RetencionCompra.
 * Almacena los datos de retención de compra (tabla pgs.rtcm).
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "RTCM", schema = "PGS")
@NamedQueries({
	@NamedQuery(name = "RetencionCompraAll", query = "select e from RetencionCompra e"),
	@NamedQuery(name = "RetencionCompraId", query = "select e from RetencionCompra e where e.id = :id")
})
public class RetencionCompra implements Serializable {
	...
	private Long estado;
        ...
        /**
         * Asiento contable generado al contabilizar la retención de compra.
         */
        @ManyToOne
