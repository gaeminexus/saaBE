...
/**
*  @author GaemiSoft
*  Pojo mapeo de tabla PGS.TDTP.
*  Entity TempDetalleDocumentoPago.
*  Detalle de documento en el que se almancenan todos los productos incluidos en el documento.
*/
@SuppressWarnings("serial")
@Entity
@Table(name = "TDTP", schema = "PGS")
@SequenceGenerator(name = "SQ_TDTPCDGO", sequenceName = "PGS.SQ_TDTPCDGO", allocationSize = 1)
@NamedQueries({
	@NamedQuery(name = "TempDetalleDocumentoPagoAll", query = "select e from TempDetalleDocumentoPago e"),
	@NamedQuery(name = "TempDetalleDocumentoPagoId", query = "select e from TempDetalleDocumentoPago e where e.codigo = :id")
})
public class TempDetalleDocumentoPago implements Serializable {

	/**
	 * Codigo de la entidad.
	 */
	@Id
	@Column(name = "TDTPCDGO", precision = 0)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_TDTPCDGO")
	private Long codigo;
	 ...
	 * @param tempDocumentoPago : Documento al que pertenece el detalle. 
	 */
