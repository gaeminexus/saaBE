...
/**
*  @author GaemiSoft
*  Pojo mapeo de tabla PGS.PAFP.
*  Entity PagosArbitrariosXFinanciacionPago.
*  Pagos arbitrarios de financiacion de pago 
*   en caso de que no se financie en pagos periodicos sino en pagos arbitrarios.
*/
@SuppressWarnings("serial")
@Entity
@Table(name = "PAFP", schema = "PGS")
@SequenceGenerator(name = "SQ_PAFPCDGO", sequenceName = "PGS.SQ_PAFPCDGO", allocationSize = 1)
@NamedQueries({
	@NamedQuery(name = "PagosArbitrariosXFinanciacionPagoAll", query = "select e from PagosArbitrariosXFinanciacionPago e"),
	@NamedQuery(name = "PagosArbitrariosXFinanciacionPagoId", query = "select e from PagosArbitrariosXFinanciacionPago e where e.codigo = :id")
})
public class PagosArbitrariosXFinanciacionPago implements Serializable {

	/**
	 * Codigo de la entidad.
	 */
	@Id
	@Column(name = "PAFPCDGO", precision = 0)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_PAFPCDGO")
	private Long codigo;
