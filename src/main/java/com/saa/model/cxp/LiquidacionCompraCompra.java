...
/**
 * Entity LiquidacionCompraCompra.
 * Almacena los datos de liquidación en compra (tabla pgs.lqcc).
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LQCC", schema = "PGS")
@NamedQueries({
	@NamedQuery(name = "LiquidacionCompraCompraAll", query = "select e from LiquidacionCompraCompra e"),
	@NamedQuery(name = "LiquidacionCompraCompraId", query = "select e from LiquidacionCompraCompra e where e.id = :id")
})
public class LiquidacionCompraCompra implements Serializable {
	...
	private Long estado;
        ...
        /**
         * Asiento contable generado al contabilizar la liquidación de compra.
         */
        @ManyToOne
