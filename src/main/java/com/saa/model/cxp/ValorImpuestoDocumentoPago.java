...
/**
*  @author GaemiSoft
*  Pojo mapeo de tabla PGS.VIDP.
*  Entity ValorImpuestoDocumentoPago.
...
@Entity
@Table(name = "VIDP", schema = "PGS")
@SequenceGenerator(name = "SQ_VIDPCDGO", sequenceName = "PGS.SQ_VIDPCDGO", allocationSize = 1)
@NamedQueries({
	@NamedQuery(name = "ValorImpuestoDocumentoPagoAll", query = "select e from ValorImpuestoDocumentoPago e"),
	@NamedQuery(name = "ValorImpuestoDocumentoPagoId", query = "select e from ValorImpuestoDocumentoPago e where e.codigo = :id")
})
public class ValorImpuestoDocumentoPago implements Serializable {

	/**
	 * Codigo de la entidad.
	 */
	@Id
	@Column(name = "VIDPCDGO", precision = 0)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_VIDPCDGO")
	private Long codigo;
