...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public String uploadFile(InputStream inputStream, String fileName, String uploadPath) throws Throwable {
        try {
            // Validar extensión
    ...
    public String uploadFile(InputStream inputStream, String fileName) throws Throwable {
        return uploadFile(inputStream, fileName, DEFAULT_UPLOAD_DIR);
    }
