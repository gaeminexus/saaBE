...
public class DocumentoPagoRest {
    ...
    public Response getAll() {
        try {
            List<DocumentoPago> lista = DocumentoPagoDaoService.selectAll(NombreEntidadesPago.DOCUMENTO_PAGO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            DocumentoPago registro = DocumentoPagoDaoService.selectById(id, NombreEntidadesPago.DOCUMENTO_PAGO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(DocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO PUT - DOCUMENTO_PAGO");
        try {
            DocumentoPago actualizado = DocumentoPagoService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(DocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO POST - DOCUMENTO_PAGO");
        try {
            DocumentoPago creado = DocumentoPagoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<DocumentoPago> lista = DocumentoPagoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
