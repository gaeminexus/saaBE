...
public class TempDocumentoPagoRest {
    ...
    public Response getAll() {
        try {
            List<TempDocumentoPago> lista = TempDocumentoPagoDaoService.selectAll(NombreEntidadesPago.TEMP_DOCUMENTO_PAGO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            TempDocumentoPago registro = TempDocumentoPagoDaoService.selectById(id, NombreEntidadesPago.TEMP_DOCUMENTO_PAGO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(TempDocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO PUT - TEMP_DOCUMENTO_PAGO");
        try {
            TempDocumentoPago actualizado = TempDocumentoPagoService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(TempDocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO POST - TEMP_DOCUMENTO_PAGO");
        try {
            TempDocumentoPago creado = TempDocumentoPagoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<TempDocumentoPago> lista = TempDocumentoPagoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
