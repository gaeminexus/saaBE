...
public class FinanciacionXDocumentoPagoRest {
    ...
    public Response getAll() {
        try {
            List<FinanciacionXDocumentoPago> lista = FinanciacionXDocumentoPagoDaoService.selectAll(NombreEntidadesPago.FINANCIACION_X_DOCUMENTO_PAGO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            FinanciacionXDocumentoPago registro = FinanciacionXDocumentoPagoDaoService.selectById(id, NombreEntidadesPago.FINANCIACION_X_DOCUMENTO_PAGO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(FinanciacionXDocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO PUT - FINANCIACION_X_DOCUMENTO_PAGO");
        try {
            FinanciacionXDocumentoPago actualizado = FinanciacionXDocumentoPagoService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(FinanciacionXDocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO POST - FINANCIACION_X_DOCUMENTO_PAGO");
        try {
            FinanciacionXDocumentoPago creado = FinanciacionXDocumentoPagoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<FinanciacionXDocumentoPago> lista = FinanciacionXDocumentoPagoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
