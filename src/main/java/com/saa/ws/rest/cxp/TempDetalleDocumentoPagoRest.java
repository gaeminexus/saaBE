...
public class TempDetalleDocumentoPagoRest {
    ...
    public Response getAll() {
        try {
            List<TempDetalleDocumentoPago> lista = TempDetalleDocumentoPagoDaoService.selectAll(NombreEntidadesPago.TEMP_DETALLE_DOCUMENTO_PAGO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            TempDetalleDocumentoPago registro = TempDetalleDocumentoPagoDaoService.selectById(id, NombreEntidadesPago.TEMP_DETALLE_DOCUMENTO_PAGO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(TempDetalleDocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO PUT - TEMP_DETALLE_DOCUMENTO_PAGO");
        try {
            TempDetalleDocumentoPago actualizado = TempDetalleDocumentoPagoService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(TempDetalleDocumentoPago registro) {
        System.out.println("LLEGA AL SERVICIO POST - TEMP_DETALLE_DOCUMENTO_PAGO");
        try {
            TempDetalleDocumentoPago creado = TempDetalleDocumentoPagoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<TempDetalleDocumentoPago> lista = TempDetalleDocumentoPagoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
