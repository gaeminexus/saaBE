...
public class ProductoPagoRest {
    ...
    public Response getAll() {
        try {
            List<ProductoPago> lista = ProductoPagoDaoService.selectAll(NombreEntidadesPago.PRODUCTO_PAGO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            ProductoPago registro = ProductoPagoDaoService.selectById(id, NombreEntidadesPago.PRODUCTO_PAGO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(ProductoPago registro) {
        System.out.println("LLEGA AL SERVICIO PUT - PRODUCTO_PAGO");
        try {
            ProductoPago actualizado = ProductoPagoService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(ProductoPago registro) {
        System.out.println("LLEGA AL SERVICIO POST - PRODUCTO_PAGO");
        try {
            ProductoPago creado = ProductoPagoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<ProductoPago> lista = ProductoPagoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
