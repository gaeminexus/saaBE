...
public class ImpuestoXGrupoPagoRest {
    ...
    public Response getAll() {
        try {
            List<ImpuestoXGrupoPago> lista = ImpuestoXGrupoPagoDaoService.selectAll(NombreEntidadesPago.IMPUESTO_X_GRUPO_PAGO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            ImpuestoXGrupoPago registro = ImpuestoXGrupoPagoDaoService.selectById(id, NombreEntidadesPago.IMPUESTO_X_GRUPO_PAGO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(ImpuestoXGrupoPago registro) {
        System.out.println("LLEGA AL SERVICIO PUT - IMPUESTO_X_GRUPO_PAGO");
        try {
            ImpuestoXGrupoPago actualizado = ImpuestoXGrupoPagoService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(ImpuestoXGrupoPago registro) {
        System.out.println("LLEGA AL SERVICIO POST - IMPUESTO_X_GRUPO_PAGO");
        try {
            ImpuestoXGrupoPago creado = ImpuestoXGrupoPagoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<ImpuestoXGrupoPago> lista = ImpuestoXGrupoPagoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
