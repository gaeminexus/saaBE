...
public class ContratoRest {
    ...
    public Response getAll() {
        try {
            List<Contrato> lista = ContratoDaoService.selectAll(NombreEntidadesRhh.CONTRATO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            Contrato registro = ContratoDaoService.selectById(id, NombreEntidadesRhh.CONTRATO);
            if (registro == null) {
    ...
    public Response put(Contrato registro) {
        ...
        try {
            Contrato actualizado = ContratoService.saveSingle(registro);
    ...
    public Response post(Contrato registro) {
        ...
        try {
            Contrato creado = ContratoService.saveSingle(registro);
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            List<Contrato> lista = ContratoService.selectByCriteria(registros);
            return Response.status(Response.Status.OK).entity(lista).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
