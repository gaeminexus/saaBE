...
import com.saa.ejb.crd.dao.EstadoCesantiaDaoService;
import com.saa.ejb.crd.service.EstadoCesantiaService;
import com.saa.model.crd.EstadoCesantia;
...
@Path("escs")
public class EstadoCesantiaRest {
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) throws Throwable {
        System.out.println("selectByCriteria de Estado Cesantia");
        Response respuesta = null;
        try {
            respuesta = Response.status(Response.Status.OK).entity(estadoCesantiaService.selectByCriteria(registros)).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
