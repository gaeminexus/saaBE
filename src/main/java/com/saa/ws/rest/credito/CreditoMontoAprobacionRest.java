...
import com.saa.ejb.credito.dao.CreditoMontoAprobacionDaoService;
...
@Path("crdt")
public class CreditoMontoAprobacionRest {

    @EJB
    private CreditoMontoAprobacionDaoService creditoMontoAprobacionDaoService;

    @EJB
    private CreditoMontoAprobacionService creditoMontoAprobacionService;
     ...
     * Default constructor.
     */
    public CreditoMontoAprobacionRest() {
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) throws Throwable {
        System.out.println("selectByCriteria de Credito Monto Aprobacion");
        Response respuesta = null;
        try {
            respuesta = Response.status(Response.Status.OK).entity(creditoMontoAprobacionService.selectByCriteria(registros)).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
