...
public class TempCuotaXFinanciacionCobroRest {
    ...
    public Response getAll() {
        try {
            List<TempCuotaXFinanciacionCobro> lista = tempCuotaXFinanciacionCobroDaoService.selectAll(NombreEntidadesCobro.TEMP_CUOTA_X_FINANCIACION_COBRO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            TempCuotaXFinanciacionCobro registro = tempCuotaXFinanciacionCobroDaoService.selectById(id, NombreEntidadesCobro.TEMP_CUOTA_X_FINANCIACION_COBRO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(TempCuotaXFinanciacionCobro registro) {
        System.out.println("LLEGA AL SERVICIO PUT");
        try {
            TempCuotaXFinanciacionCobro resultado = tempCuotaXFinanciacionCobroService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(TempCuotaXFinanciacionCobro registro) {
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            return Response.status(Response.Status.OK)
                    .entity(tempCuotaXFinanciacionCobroService.selectByCriteria(registros))
