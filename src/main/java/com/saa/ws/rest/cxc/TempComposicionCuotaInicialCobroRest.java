...
public class TempComposicionCuotaInicialCobroRest {
    ...
    public Response getAll() {
        try {
            List<TempComposicionCuotaInicialCobro> lista = tempComposicionCuotaInicialCobroDaoService.selectAll(NombreEntidadesCobro.TEMP_COMPOSICION_CUOTA_INICIAL_COBRO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            TempComposicionCuotaInicialCobro registro = tempComposicionCuotaInicialCobroDaoService.selectById(id, NombreEntidadesCobro.TEMP_COMPOSICION_CUOTA_INICIAL_COBRO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(TempComposicionCuotaInicialCobro registro) {
        System.out.println("LLEGA AL SERVICIO PUT");
        try {
            TempComposicionCuotaInicialCobro resultado = tempComposicionCuotaInicialCobroService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(TempComposicionCuotaInicialCobro registro) {
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            return Response.status(Response.Status.OK)
                    .entity(tempComposicionCuotaInicialCobroService.selectByCriteria(registros))
