...
public class TempDocumentoCobroRest {
    ...
    public Response getAll() {
        try {
            List<TempDocumentoCobro> lista = tempDocumentoCobroDaoService.selectAll(NombreEntidadesCobro.TEMP_DOCUMENTO_COBRO);
    ...
    public Response getId(@PathParam("id") Long id) {
        try {
            TempDocumentoCobro registro = tempDocumentoCobroDaoService.selectById(id, NombreEntidadesCobro.TEMP_DOCUMENTO_COBRO);
            if (registro == null) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(TempDocumentoCobro registro) {
        System.out.println("LLEGA AL SERVICIO PUT");
        try {
            TempDocumentoCobro resultado = tempDocumentoCobroService.saveSingle(registro);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(TempDocumentoCobro registro) {
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) {
        ...
        try {
            return Response.status(Response.Status.OK)
                    .entity(tempDocumentoCobroService.selectByCriteria(registros))
