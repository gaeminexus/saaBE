...
public class ValorImpuestoDocumentoCobroRest {
    ...
    public List<ValorImpuestoDocumentoCobro> getAll() throws Throwable {
        return valorImpuestoDocumentoCobroDaoService.selectAll(NombreEntidadesCobro.VALOR_IMPUESTO_DOCUMENTO_COBRO);
    }
    ...
    @Path("/getId/{id}")
    @Produces("application/json")
    public ValorImpuestoDocumentoCobro getId(@PathParam("id") Long id) throws Throwable {
        return valorImpuestoDocumentoCobroDaoService.selectById(id, NombreEntidadesCobro.VALOR_IMPUESTO_DOCUMENTO_COBRO);
    }

    /**
     * PUT method for updating or creating an instance of ValorImpuestoDocumentoCobroRest
     * 
    ...
    public Response put(ValorImpuestoDocumentoCobro registro) throws Throwable {
        System.out.println("LLEGA AL SERVICIO PUT");
        Response respuesta = null;
        try {
            respuesta = Response.status(Response.Status.OK).entity(valorImpuestoDocumentoCobroService.saveSingle(registro)).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
    ...
    /**
     * POST method for updating or creating an instance of ValorImpuestoDocumentoCobroRest
     * 
     * @param content representation for the resource
     * @return an HTTP response with content of the updated or created resource.
     */
    @POST
    @Consumes("application/json")
    public Response post(ValorImpuestoDocumentoCobro registro) throws Throwable {
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) throws Throwable {
        ...
        Response respuesta = null;
        try {
            respuesta = Response.status(Response.Status.OK).entity(valorImpuestoDocumentoCobroService.selectByCriteria(registros)).type(MediaType.APPLICATION_JSON).build();
        } catch (Throwable e) {
            respuesta = Response.status(Response.Status.BAD_REQUEST).entity(e.getMessage()).type(MediaType.APPLICATION_JSON).build();
        }
        return respuesta;
