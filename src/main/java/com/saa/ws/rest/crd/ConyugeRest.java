...
public class ConyugeRest {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response put(Conyuge registro, @QueryParam("usuario") String usuario) {
        System.out.println("LLEGA AL SERVICIO PUT - CNYG");
        try {
            Conyuge resultado = conyugeService.saveSingle(registro, usuario);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response post(Conyuge registro, @QueryParam("usuario") String usuario) {
