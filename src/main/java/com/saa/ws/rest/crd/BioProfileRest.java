...
import com.saa.ejb.crd.service.BioProfileService;
...
@Path("bprf")
public class BioProfileRest {

    @EJB
    private BioProfileDaoService bioProfileDaoService;

    @EJB
    private BioProfileService bioProfileService;

    @Context
    private UriInfo context;

    public BioProfileRest() {
    }
    ...
    public Response selectByCriteria(List<DatosBusqueda> registros) throws Throwable {
        System.out.println("selectByCriteria de BIOPROFILE");
        Response respuesta = null;
        try {
            respuesta = Response.status(Response.Status.OK)
                    .entity(bioProfileService.selectByCriteria(registros))
